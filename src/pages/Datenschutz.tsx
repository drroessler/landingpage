  ...
  return (
    <LegalLayout title="Datenschutzerklärung">
      <section>
        ...
        <h3 className="font-semibold text-ink mt-6 mb-2">Allgemeine Hinweise</h3>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          88 Colin P Kelly Jr St, San Francisco, CA 94107, USA. Beim Besuch dieser
          Website erfasst GitHub automatisch Informationen in sogenannten
          Server-Log-Dateien, die Ihr Browser automatisch übermittelt. Details
          entnehmen Sie der Datenschutzerklärung von GitHub:{" "}
          <a
      ...
      <section>
        ...
        <h3 className="font-semibold text-ink mt-6 mb-2">Datenschutz</h3>
        <p>
        ...
        <h3 className="font-semibold text-ink mt-6 mb-2">Speicherdauer</h3>
        <p>
        ...
        <p>
          ...
          Beschwerderecht bei einer Aufsichtsbehörde zu. Das Beschwerderecht besteht
      ...
      <section>
        ...
        <h3 className="font-semibold text-ink mt-6 mb-2">Cookies</h3>
        <p>
          Diese Website verwendet keine Cookies.
        </p>

        <h3 className="font-semibold text-ink mt-6 mb-2">Kontaktaufnahme per E-Mail</h3>
        <p>
      ...
      <section>
        ...
        <h3 className="font-semibold text-ink mt-6 mb-2">Umami Analytics</h3>
        <p>
          Diese Website nutzt Umami, eine datenschutzfreundliche Web-Analyse-Lösung.
          Umami verwendet keine Cookies und erfasst keine personenbezogenen Daten. Die
          erhobenen Daten werden anonymisiert verarbeitet und dienen ausschließlich der
          statistischen Auswertung der Websitenutzung. Es werden keine Daten an Dritte
          weitergegeben.
        </p>
      </section>
    </LegalLayout>
