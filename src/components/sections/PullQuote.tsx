      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <AnimatedContent>
          <blockquote className="font-display text-2xl md:text-3xl lg:text-4xl text-ink leading-snug">
            Nicht die Technologie entscheidet über den Erfolg eines Vorhabens
            — sondern ob alle Beteiligten das Problem wirklich verstanden haben.
          </blockquote>
          <div className="mt-8 flex items-center justify-center gap-3">
            <div className="w-8 h-px bg-accent" />
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-muted">
              Die NarraTec-Überzeugung
            </span>
            <div className="w-8 h-px bg-accent" />
          </div>
        </AnimatedContent>
