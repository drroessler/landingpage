...
export const en: Translations = {
  ...
  datenschutz: {
    ...
    s2: "2. Hosting",
    s2_text: "This website is hosted by Vercel. The provider is Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA. When you access this website, Vercel automatically collects information in so-called server log files that your browser transmits (including IP address, time, page requested). The basis is our legitimate interest in the secure and reliable operation of the website (Art. 6(1)(f) GDPR). A data processing agreement is in place with Vercel; transfers to the USA are based on the European Commission's Standard Contractual Clauses. Details can be found in Vercel's privacy policy:",
    ...
    s4_check: "Readiness check (self-assessment)",
    s4_checkText: "On this website you can complete a readiness check for your IT initiative. In doing so we process the answers you select to nine questions as well as the contact details you provide: name, email address, organisation and — if given — your role. The questions contain no free-text fields.",
    s4_checkPurpose: "The purpose of processing is to send you the evaluation as a PDF document by email and to handle your enquiry. The evaluation is generated by rules: each answer option outputs a predefined text. There is no automated decision-making within the meaning of Art. 22 GDPR, and no language model is involved.",
    s4_checkLegal: "The legal basis is your consent under Art. 6(1)(a) GDPR, which you give explicitly before submitting. You may withdraw this consent at any time without formality, for example by sending an email to contact@narratec.io. The lawfulness of processing carried out before withdrawal remains unaffected.",
    s4_checkStorage: "We store your details and the resulting evaluation in our contact management system at Notion. The provider is Notion Labs, Inc., 2300 Harrison St, San Francisco, CA 94110, USA. A data processing agreement is in place with Notion; transfers to the USA are based on the European Commission's Standard Contractual Clauses. The evaluation is sent from our own email account; no additional mail service provider is involved. We delete your data as soon as the purpose no longer applies, and at the latest 24 months after the last contact — unless statutory retention obligations require otherwise.",
