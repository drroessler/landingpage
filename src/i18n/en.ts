...
export const en: Translations = {
  ...
  artefakt: {
    ...
    features: [
      ...
      },
      {
        ...
        text: "No more outdated emails and PPT versions \"Final_v3\". All stakeholders work in the same living document.",
      },
      {
  ...
  szenarien: {
    ...
    desc: "Not every problem needs a narrative. But where complexity meets implementation pressure, our approach is unmatched.",
    cases: [
      {
        title: "Strategic Transformation",
        text: "Major changes often fail due to unclear goals. Use the method to plan complex initiatives (e.g., reorganizations, new business models) with rigor.",
        checks: [
          "Stakeholder alignment before project start",
          "Securing budget & resources",
        ],
      },
      {
        title: "Technical Sales",
        text: "Replace standard pitches with co-creation. Work together with the customer to develop a narrative that describes their problem better than they could themselves.",
        checks: [
          "Trust through deep understanding",
          "Tailored solution building blocks",
        ],
      },
      {
        title: "Task Forces & Crises",
        text: "When things are on fire, activism doesn't help — cool analysis does. The format forces the crisis team to step back and find the true root cause.",
        checks: [
          "Systematic root-cause research",
  ...
  praxis: {
    label: "From Practice",
    heading: "Three real use cases.",
    desc: "The method is regularly deployed in demanding enterprise settings.",
    ...
    cases: [
      {
        ...
        ausgangslage: "Teams from factory IT, brand IT, central IT, and business units needed to jointly realign IT architecture and IT organization in the production environment — but worked with different priorities, time horizons, and domain languages.",
        vorgehen: "The method enforced a consistent root-cause analysis from human, organizational, and technical perspectives. Strict separation of problem and solution prevented premature fixation on isolated approaches. A north-star narrative created cross-team orientation, while derived focus narratives made the work manageable in individual areas. The transition to the Scaled Agile Framework (SAFe) led to team reformation and changed ways of working. The narrative was iteratively adapted after initial feedback loops.",
        ergebnis: "Jointly supported target architecture. Implementation in an agile product organization with a double-digit number of teams. Risk-reduced, phased budgeting.",
        outcome: "Risk-reduced budgeting",
      },
      {
        tag: "Case 2 · Governance",
        title: "Open-Source Approval Process",
        ausgangslage: "A sluggish open-source approval process was slowing down software delivery. Three teams — Legal, Development, and the Open Source Office — each optimized locally without developing a shared understanding of the problem.",
        vorgehen: "The method brought all three groups to the table as equals. The structured narrative uncovered organizational and human causes alongside technical ones — connections that would have remained invisible in isolated analysis.",
        ergebnis: "Holistic target state instead of isolated solutions. The jointly supported solution led to significant acceleration of approval timelines.",
        outcome: "Significant acceleration",
      },
      {
        tag: "Case 3 · Strategic IT",
        title: "AI Delivery Model",
        ausgangslage: "Central IT, multiple brand domains, and Business Partner Management needed to jointly develop a delivery model for AI software products — across hierarchy levels, with partially conflicting requirements.",
        vorgehen: "The method structured the narrative along the phases of the product lifecycle and made the tension between thoroughness and speed manageable despite a high number of stakeholders. The complexity led to thematically heterogeneous solution building blocks — from technical implementations to community building.",
        ergebnis: "Transparency about required fields of action given high organizational complexity. Modular implementation of the heterogeneous solution building blocks.",
